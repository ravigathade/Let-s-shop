...
public class Rahul {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			System.out.println(
					pro.findElement(By.cssSelector(".card-body button:last-of-type")).getText() + " button clicked");
		...
		//	Thread.sleep(2000);
			...
			//driver.findElement(By.cssSelector("[placeholder='Select Country']")).sendKeys(Keys.ENTER);
